...
RF_OVERCOMMIT_EXPECTED_FILL_COST_FRAC: float = 0.02  # FX-052/053: assumed slippage fraction for the expected_fill_cost calc. With FX-056 extreme-price filter, most reward markets sit near midpoint and slip ~1-3% on dump. Markets where (expected_reward_per_day × q_share) < (position_notional × this) are skipped — keeps deploys positive-EV per Ground Rule 1 + 3. Calibrate post-G1 against measured slippage distribution.
