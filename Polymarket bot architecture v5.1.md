...
## Current Production State (v6.5 — FX-078/080/081/082 shipped; bot in P5 Stage B shadow on Helsinki; local repo at ~/code)

Updated 2026-06-01 (v6.5: persistence cluster FX-078/080 + FX-081/082 + repo relocate). Rows where I'm uncertain about a fact are marked **(unverified)** rather than guessed; operator can confirm against Helsinki on next access. **v6.4 doc change:** legacy/rollback component sections (former §4.12 Bandit, §4.14 SafetyController, §4.15 β/η Continuous Allocator, §4.16 β/η Control System, §4.17 Patch-6–13 stack) consolidated into a single §4.14b; full detail preserved in git @ `c074446`.
